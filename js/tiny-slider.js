var tns = function() {
    ...
    var R = function(t) {
        ...
        var I, P, z, W, F, q, j, V = b.tC ? r(b.tC) : o(b, "tC", function() {
            ...
            G = b.tPL ? r(b.tPL) : o(b, "tPL", function() {
                var t, e = document,
                    n = u(),
                    i = s(n),
        ...
        if (et.forEach((function(e) {
            ...
            var vt, pt, ht = "horizontal" === t.axis,
            ...
            var Et, Nt, At, Lt, Bt, St, Ot, Dt = t.autoWidth,
                Ht = Fn("fixedWidth"),
                kt = Fn("edgePadding"),
                Rt = Fn("gutter"),
                It = zn(),
                ...
                }(), St = rt ? Math.ceil((5 * Bt - wt) / 2) : 4 * Bt - wt, St = Math.max(Bt, St), Wn("edgePadding") ? St + 1 : St) : 0,
                oe = rt ? wt + 2 * re : wt + re,
                ue = !(!Ht && !Dt || Gt),
                le = Ht ? Bi() : null,
                se = !rt || !Gt,
            ...
            if (ze) var Ke, Je, Ue = t.controlsContainer,
            ...
            if (We) var nn, an = t.navContainer,
            ...
            Dt || On(Ne || Be), X && (ce = X, fe = "translate", Y ? (fe += ht ? "3d(" : "3d(0px, ", de = ht ? ", 0px, 0px)" : ", 0px)") : (fe += ht ? "X(" : "Y(", de = ")")), rt && (gt.className = gt.className.replace("tns-vpfix", "")),
                ...
                function() {
                    ...
                    if (ht && (G || Dt ? (f(ne, "#" + Ee + " > .tns-item", "font-size:" + l.getComputedStyle(Ct[0]).fontSize + ";", d(ne)), f(ne, "#" + Ee, "font-size:0;", d(ne))) : rt && v(Ct, (function(t, e) {
                            var n;
                        ...
                        a = qn(t.edgePadding, t.gutter, t.fixedWidth, t.speed, t.autoHeight), f(ne, "#" + Ee + "-iw", a, d(ne)), rt && (a = ht && !Dt ? "width:" + jn(t.fixedWidth, t.gutter, t.items) + ";" : "", K && (a += Xn(jt)), f(ne, "#" + Ee, a, d(ne))), a = ht && !Dt ? Vn(t.fixedWidth, t.gutter, t.items) : "", t.gutter && (a += Gn(t.gutter)), rt || (K && (a += Xn(jt)), U && (a += Yn(jt))), a && f(ne, "#" + Ee + " > .tns-item", a, d(ne))
                    } else {
            ...
            var Bn = Gt ? rt ? function() {
                ...
                Sn = rt ? function() {
                    ...
                    Ai(gt, ""), K || !jt ? (Di(), jt && N(gt) || Ii()) : (t = gt, e = ce, n = fe, i = de, a = Si(), r = jt, o = Ii, u = Math.min(r, 10), l = 0 <= a.indexOf("%") ? "%" : "px", a = a.replace(l, ""), s = Number(t.style[e].replace(n, "").replace(i, "").replace(l, "")), c = (a - s) / r * u, setTimeout((function a() {
            ...
            return {
                ...
                refresh: Kn,
                destroy: function() {
                    if (ne.disabled = !0, ne.ownerNode && ne.ownerNode.remove(), H(l, {
                            resize: $n
                        }), qt && H(n, Re), Ue && H(Ue, Oe), an && H(an, De), H(gt, He), H(gt, ke), bn && H(bn, {
                            click: Gi
                        }), _t && clearInterval(pn), rt && Z) {
                        var e = {};
                        e[Z] = Ii, H(gt, e)
                    }
                    ...
                    for (var a in et.forEach((function(e, n) {
                        ...
                        })), et = st = ct = ft = dt = ht = mt = yt = gt = xt = bt = Ct = wt = pt = Mt = Dt = Ht = kt = Rt = It = zt = Wt = Ft = qt = jt = Vt = Gt = Qt = ne = ie = Et = ae = re = oe = ue = le = se = ce = fe = de = ve = pe = he = me = ye = xe = be = Ce = we = Me = Te = Ee = Ne = Ae = Le = Be = Se = Oe = De = He = ke = Re = Ie = Pe = ze = We = Fe = qe = je = Ve = Ge = Qe = Xe = Nt = Xt = Yt = Ue = _e = Ze = $e = Ke = Je = Kt = an = rn = nn = on = un = ln = sn = cn = fn = dn = vn = _t = Zt = xn = $t = te = bn = Cn = ee = wn = pn = hn = mn = yn = gn = En = Nn = Mn = An = Tn = Ln = Jt = Ut = null, this) "rebuild" !== a && (this[a] = null);
                    Tt = !1
                },
                rebuild: function() {
                    return R(a(t, nt))
        ...
        function Kn() {
            if (Wn("autoHeight") || Dt || !ht) {
                ...
                })), !Dt && ht && (t = vi(pe, Math.min(pe + zt - 1, oe - 1))), ie ? Jn() : e((function() {
                    hi(M(t), Jn)
                }))
            } else rt && Oi(), _n(), Zn()
        }
        ...
        function _n() {
            if (Ci(), mt.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + li() + "</span>  of " + wt + "</div>"), At = mt.querySelector(".tns-liveregion .current"), qe) {
                var e = _t ? "stop" : "start";
                bn ? C(bn, {
                    "data-action": e
                }) : t.autoplayButtonOutput && (mt.insertAdjacentHTML(Pn(t.autoplayPosition), '<button data-action="' + e + '">' + wn[0] + e + wn[1] + $t[0] + "</button>"), bn = mt.querySelector("[data-action]")), bn && D(bn, {
                    click: Gi
            ...
            if (We) {
                ...
                }), w(nn[sn], "tabindex"), m(nn[sn], fn), D(an, De)
            }
            ze && (Ue || Ze && $e || (mt.insertAdjacentHTML(Pn(t.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button data-controls="prev" tabindex="-1" aria-controls="' + Ee + '">' + Yt[0] + '</button><button data-controls="next" tabindex="-1" aria-controls="' + Ee + '">' + Yt[1] + "</button></div>"), Ue = mt.querySelector(".tns-controls")), Ze && $e || (Ze = Ue.children[0], $e = Ue.children[1]), t.controlsContainer && C(Ue, {
                ...
                "data-controls": "next"
            })), Ke = Mi(Ze), Je = Mi($e), Ni(), Ue ? D(Ue, Oe) : (D(Ze, Oe), D($e, Oe))), ii()
        }
        ...
        function Zn() {
            ...
            Jt && D(gt, Ie, t.preventScrollOnTouch), Ut && D(gt, Pe), qt && D(n, Re), "inner" === at ? Me.on("outerResized", (function() {
                ti(), Me.emit("innerLoaded", ia())
            })) : (it || Ht || Dt || Qt || !ht) && D(l, {
                resize: $n
            }), Qt && ("outer" === at ? Me.on("innerLoaded", pi) : Ne || pi()), ci(), Ne ? oi() : Be && ri(), Me.on("indexChanged", mi), "inner" === at && Me.emit("innerLoaded", ia()), "function" == typeof we && we(ia()), Tt = !0
        }
        ...
        function ti(e) {
            if (Tt) {
                ...
                if (qt = Fn("arrowKeys"), Xt = Fn("controls"), Kt = Fn("nav"), Jt = Fn("touch"), Pt = Fn("center"), Ut = Fn("mouseDrag"), _t = Fn("autoplay"), te = Fn("autoplayHoverPause"), ee = Fn("autoplayResetOnVisibility"), i && (Ne = Fn("disable"), Ht = Fn("fixedWidth"), jt = Fn("speed"), Qt = Fn("autoHeight"), Yt = Fn("controlsText"), $t = Fn("autoplayText"), Zt = Fn("autoplayTimeout"), Q || (kt = Fn("edgePadding"), Rt = Fn("gutter"))), On(Ne), It = zn(), ht && !Dt || Ne || (bi(), ht || (ta(), r = !0)), (Ht || Dt) && (le = Bi(), ye = ve()), (i || Ht) && (zt = Fn("items"), Wt = Fn("slideBy"), (u = zt !== c) && (Ht || Dt || (ye = ve()), Bn())), i && Ne !== p && (Ne ? oi() : function() {
                    ...
                    }()), Le && (i || Ht || Dt) && (Be = ei()) !== h && (Be ? (Di(Si(Hn(0))), ri()) : (function() {
                        if (Se) {
                            if (kt && Q && (yt.style.margin = ""), re)
                                for (var t = "tns-transparent", e = re; e--;) rt && y(Ct[e], t), y(Ct[oe - e - 1], t);
                            ai(), Se = !1
                        }
                    }(), r = !0)), On(Ne || Be), _t || (te = ee = !1), qt !== g && (qt ? D(n, Re) : H(n, Re)), Xt !== x && (Xt ? Ue ? E(Ue) : (Ze && E(Ze), $e && E($e)) : Ue ? T(Ue) : (Ze && T(Ze), $e && T($e))), Kt !== b && (Kt ? E(an) : T(an)), Jt !== C && (Jt ? D(gt, Ie, t.preventScrollOnTouch) : H(gt, Ie)), Ut !== w && (Ut ? D(gt, Pe) : H(gt, Pe)), _t !== M && (_t ? (bn && E(bn), hn || yn || ji()) : (bn && T(bn), hn && Vi())), te !== N && (te ? D(gt, He) : H(gt, He)), ee !== A && (ee ? D(n, ke) : H(n, ke)), i) {
                ...
                if ((u || Ht && !Dt) && (on = ea(), na()), (o = pe !== L) ? (Me.emit("indexChanged", ia()), r = !0) : u ? o || mi() : (Ht || Dt) && (ci(), Ci(), ui()), u && !rt && function() {
        ...
        function oi() {
            if (!Ae) {
                if (ne.disabled = !0, gt.className = gt.className.replace(Te.substring(1), ""), w(gt, ["style"]), Gt)
        ...
        function si(t) {
            null == t && (t = Si());
            var e, n, i, a = pe;
            if (Pt || kt ? (Dt || Ht) && (n = -(parseFloat(t) + kt), i = n + It + 2 * kt) : Dt && (n = Et[pe], i = n + It), Dt) Et.forEach((function(t, r) {
                r < oe && ((Pt || kt) && t <= n + .5 && (a = r), .5 <= i - t && (e = r))
            }));
            else {
                if (Ht) {
                    var r = Ht + Rt;
        ...
        function ci() {
            ie && !Ne && vi.apply(null, si()).forEach((function(t) {
                if (!h(t, Qe)) {
                    ...
                    e[Z] = function(t) {
                        t.stopPropagation()
                    }, D(t, e), D(t, Xe), t.src = x(t, "data-src");
        ...
        function vi(t, e) {
            for (var n = []; t <= e;) v(Ct[t].querySelectorAll("img"), (function(t) {
                n.push(t)
            })), t++;
            return n
        }
        ...
        function Ci() {
            var t = si(),
                ...
                n = t[1];
            v(Ct, (function(t, i) {
                e <= i && i <= n ? g(t, "aria-hidden") && (w(t, ["aria-hidden", "tabindex"]), m(t, Ge)) : g(t, "aria-hidden") || (C(t, {
                    "aria-hidden": "true",
                    tabindex: "-1"
                }), y(t, Ge))
            }))
        ...
        function Pi(t, e) {
            if (!Be)
                ...
                var n = kn(),
                    i = 0;
                if ("first" === t ? i = -n : "last" === t ? i = rt ? wt - zt - n : wt - 1 - n : ("number" != typeof t && (t = parseInt(t)), isNaN(t) || (e || (t = Math.max(0, Math.min(wt - 1, t))), i = t - n)), !rt && i && Math.abs(i) < zt) {
                    var a = 0 < i ? 1 : -1;
        ...
        function Zi(t) {
            if (An) {
                var n = Xi(t);
                Nn.x = n.clientX, Nn.y = n.clientY, rt ? Tn || (Tn = e((function() {
                    ! function t(n) {
                        if (be) {
                            if (i(Tn), An && (Tn = e((function() {
                                    t(n)
                                }))), "?" === be && (be = Ui()), be) {
                                !Ye && Ki(n) && (Ye = !0);
                                try {
                ...
                }))) : ("?" === be && (be = Ui()), be && (Ye = !0)), Ye && t.preventDefault()
            }
        }
                    ...
                    rt ? Tn = e((function() {
                        if (ht && !Dt) {
                            ...
                            if (e <= 0) pe = me;
                                ...
                                for (var i = 0; i < oe && e >= Et[i];) e > Et[pe = i] && r < 0 && (pe += 1), i++
                        }
